        ...
        <div className="text-center">
          ...
          <div className="max-w-2xl mx-auto mb-8">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search for hotels, products, cars, wedding services..."
              ...
              <div className="absolute inset-y-0 right-0 flex items-center">
                <button className="bg-primary-600 hover:bg-primary-700 text-white px-6 py-4 rounded-r-lg font-medium transition-colors duration-200">
                  Search
                </button>
              </div>
            </div>
